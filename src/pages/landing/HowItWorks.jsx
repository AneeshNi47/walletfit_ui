...
const steps = [
  {
    number: '01',
    icon: <UserPlusIcon className="h-8 w-8 text-brand-emerald" />,
  ...
  {
    number: '02',
    icon: <WalletIcon className="h-8 w-8 text-brand-emerald" />,
  ...
  {
    number: '03',
    icon: <PencilSquareIcon className="h-8 w-8 text-brand-emerald" />,
  ...
  {
    number: '04',
    icon: <ChartBarSquareIcon className="h-8 w-8 text-brand-emerald" />,
    title: 'Get Insights',
    ...
    <section id="how-it-works" className="py-16 sm:py-24 px-4 sm:px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-brand-forest mb-4">How It Works</h2>
        ...
        <div className="space-y-8 sm:space-y-0 sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-8">
          {steps.map((step, index) => (
            <div key={index} className="relative text-center group">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-cream border-2 border-brand-sand mb-5 group-hover:bg-brand-warm transition-colors">
                {step.icon}
              </div>
              <div className="text-xs font-bold text-brand-sage uppercase tracking-widest mb-2">Step {step.number}</div>
